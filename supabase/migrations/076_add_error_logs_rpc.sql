-- Paginated error logs with date filter for monitoring detail view
...
GRANT EXECUTE ON FUNCTION get_error_logs(DATE, TEXT, INTEGER, INTEGER) TO authenticated;
