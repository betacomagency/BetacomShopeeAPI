...
export const apiEndpoints: ApiEndpoint[] = [
  ...
  {
    id: "get-all-cpc-ads-daily-performance",
    module: "ads",
    name: "v2.ads.get_all_cpc_ads_daily_performance",
    method: "GET",
    path: "/api/v2/ads/get_all_cpc_ads_daily_performance",
    description: "Sử dụng API này để lấy hiệu suất quảng cáo CPC (Cost-Per-Click) ở cấp độ Shop cho nhiều ngày.",
    environments: [
      {
        name: "URL",
        url: "https://partner.shopeemobile.com/api/v2/ads/get_all_cpc_ads_daily_performance",
      },
      {
        name: "Test URL",
        url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_all_cpc_ads_daily_performance",
      },
    ],
    commonParams: [
      {
    ...
    requestParams: [
      {
        ...
        required: true,
        sample: "17-03-2021",
        description: "Tham số để chỉ định ngày bắt đầu của khoảng thời gian hiệu suất. Định dạng DD-MM-YYYY.",
      },
      {
        name: "end_date",
        type: "string",
        required: true,
        sample: "18-03-2021",
        description: "Tham số để chỉ định ngày kết thúc của khoảng thời gian hiệu suất. Định dạng DD-MM-YYYY.",
      },
    ],
    responseParams: [
      {
      ...
      },
      {
        name: "response",
        type: "object[]",
        description: "Mảng chứa dữ liệu hiệu suất hàng ngày.",
      },
      {
        name: "response[].date",
        type: "string",
        sample: "17-03-2021",
        description: "Thông số để cho biết ngày bản ghi hiệu suất thuộc về. Định dạng DD-MM-YYYY.",
      },
      {
        name: "response[].impression",
        type: "int32",
      ...
      },
      {
        ...
        type: "int32",
        sample: "123",
        description: "Số lượng mặt hàng được bán trong vòng 7 ngày sau khi nhấp chuột (Miễn là từ cùng một cửa hàng). Ghi chú: Phản ánh trong Advertiser Platform là 'Conversion Rate'.",
      },
      {
        name: "response[].direct_gmv",
        type: "float",
      ...
      },
      {
        ...
        type: "float",
        sample: "1.23",
        description: "Tổng doanh thu tạo ra từ Quảng cáo (Cả mua hàng từ cùng một shop).",
      },
      {
        name: "response[].expense",
        type: "float",
      ...
      },
      {
        ...
        type: "float",
        sample: "1.23",
        description: "Quảng cáo Trực tiếp GMV/Chi phí quảng cáo (Mặt hàng từ quảng cáo đã nhấp).",
      },
      {
        name: "response[].broad_roas",
        type: "float",
  ...
  {
    id: "create-auto-product-ads",
    module: "ads",
    name: "v2.ads.create_auto_product_ads",
    method: "POST",
    path: "/api/v2/ads/create_auto_product_ads",
    description: "(Coming offline soon) Sử dụng API này để tạo quảng cáo sản phẩm tự động. Shopee sẽ tự động tối ưu hóa từ khóa và giá thầu cho các sản phẩm được chọn.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/create_auto_product_ads" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/create_auto_product_ads" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
      { name: "access_token", type: "string", sample: "c09222e3fc40ffb25fc947f738b1abf1", description: "Token truy cập." },
      { name: "shop_id", type: "int", sample: "600000", description: "ID shop." },
      { name: "sign", type: "string", sample: "e318d3e93271991...", description: "Chữ ký xác thực." },
    ],
    requestParams: [
      {
        name: "item_id_list",
        ...
        required: true,
        sample: "[123, 456]",
        description: "Danh sách ID sản phẩm muốn chạy quảng cáo tự động (tối đa 5 sản phẩm)."
      },
      {
        name: "reference_id",
        type: "string",
        ...
        description: "Một chuỗi ngẫu nhiên được sử dụng để ngăn chặn việc tạo quảng cáo trùng lặp. Nếu một quảng cáo được tạo thành công, yêu cầu tiếp theo sử dụng cùng một reference_id sẽ thất bại."
      },
      {
        name: "budget",
        type: "float",
        required: true,
        sample: "10.50",
        description: "Ngân sách được thiết lập cho Quảng cáo Sản phẩm Tự động."
      },
      {
        name: "start_date",
        type: "string",
        required: true,
        sample: "11-11-2023",
        description: "Ngày bắt đầu cho mỗi chiến dịch. Lưu ý rằng nếu bạn muốn đặt ngày không giới hạn, bạn chỉ cần gửi ngày hôm nay là ngày bắt đầu."
      },
      {
        name: "end_date",
        type: "string",
        required: false,
        description: "Ngày kết thúc của mỗi chiến dịch. Lưu ý rằng nếu bạn muốn thiết lập chiến dịch không giới hạn, bạn có thể để trống trường ngày kết thúc."
      },
    ],
    responseParams: [
      {
      ...
      {
        name: "response[].campaign_id",
        type: "int64",
        sample: "123",
        description: "Định danh duy nhất cho một chiến dịch."
      },
    ],
  },
  {
    id: "edit-auto-product-ads",
    module: "ads",
    name: "v2.ads.edit_auto_product_ads",
    method: "POST",
    path: "/api/v2/ads/edit_auto_product_ads",
    description: "(Coming offline soon) Sử dụng API này để chỉnh sửa cài đặt quảng cáo sản phẩm tự động.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/edit_auto_product_ads" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_auto_product_ads" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "ad_id", type: "int64", required: true, description: "ID quảng cáo cần chỉnh sửa." },
      { name: "status", type: "string", required: false, description: "Trạng thái mới: active hoặc paused." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "request_id", type: "string", description: "ID yêu cầu." },
    ],
  },
  {
    id: "get-product-campaign-daily-performance",
    module: "ads",
    name: "v2.ads.get_product_campaign_daily_performance",
    method: "GET",
    path: "/api/v2/ads/get_product_campaign_daily_performance",
    description: "Lấy hiệu suất hàng ngày của chiến dịch quảng cáo sản phẩm.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_product_campaign_daily_performance" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_campaign_daily_performance" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id", type: "int64", required: true, description: "ID chiến dịch." },
      { name: "start_date", type: "string", required: true, sample: "17-03-2021", description: "Ngày bắt đầu (DD-MM-YYYY)." },
      { name: "end_date", type: "string", required: true, sample: "18-03-2021", description: "Ngày kết thúc (DD-MM-YYYY)." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Dữ liệu hiệu suất hàng ngày." },
      { name: "response[].impression", type: "int32", description: "Lượt hiển thị." },
      { name: "response[].clicks", type: "int32", description: "Lượt click." },
      { name: "response[].ctr", type: "float", description: "Tỷ lệ click." },
      { name: "response[].expense", type: "float", description: "Chi phí." },
      { name: "response[].gmv", type: "float", description: "Doanh thu." },
      { name: "response[].roas", type: "float", description: "Tỷ suất lợi nhuận (ROAS)." },
    ],
  },
  {
    id: "get-product-campaign-hourly-performance",
    module: "ads",
    name: "v2.ads.get_product_campaign_hourly_performance",
    method: "GET",
    path: "/api/v2/ads/get_product_campaign_hourly_performance",
    description: "Lấy hiệu suất hàng giờ của chiến dịch quảng cáo sản phẩm trong một ngày cụ thể.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_product_campaign_hourly_performance" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_campaign_hourly_performance" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id", type: "int64", required: true, description: "ID chiến dịch." },
      { name: "performance_date", type: "string", required: true, sample: "17-03-2021", description: "Ngày kiểm tra (DD-MM-YYYY)." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Dữ liệu hiệu suất hàng giờ." },
      { name: "response[].hour", type: "int32", description: "Giờ ghi nhận." },
      { name: "response[].impression", type: "int32", description: "Lượt hiển thị." },
      { name: "response[].clicks", type: "int32", description: "Lượt click." },
    ],
  },
  {
    id: "get-product-level-campaign-id-list",
    module: "ads",
    name: "v2.ads.get_product_level_campaign_id_list",
    method: "GET",
    path: "/api/v2/ads/get_product_level_campaign_id_list",
    description: "Lấy danh sách ID chiến dịch ở cấp độ sản phẩm.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_product_level_campaign_id_list" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_level_campaign_id_list" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "int64[]", description: "Danh sách ID chiến dịch." },
    ],
  },
  {
    id: "get-product-level-campaign-setting-info",
    module: "ads",
    name: "v2.ads.get_product_level_campaign_setting_info",
    method: "GET",
    path: "/api/v2/ads/get_product_level_campaign_setting_info",
    description: "Lấy thông tin cài đặt của chiến dịch quảng cáo sản phẩm.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_product_level_campaign_setting_info" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_level_campaign_setting_info" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id_list", type: "int64[]", required: true, description: "Danh sách ID chiến dịch." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Thông tin cài đặt chiến dịch." },
    ],
  },
  {
    id: "create-manual-product-ads",
    module: "ads",
    name: "v2.ads.create_manual_product_ads",
    method: "POST",
    path: "/api/v2/ads/create_manual_product_ads",
    description: "Tạo quảng cáo sản phẩm thủ công, cho phép người bán tự chọn từ khóa và giá thầu.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/create_manual_product_ads" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/create_manual_product_ads" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "item_id", type: "int64", required: true, description: "ID sản phẩm." },
      { name: "bid_price", type: "int64", required: true, description: "Giá thầu mặc định." },
      { name: "budget", type: "float", required: true, description: "Ngân sách (0 cho không giới hạn)." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object", description: "Thông tin quảng cáo đã tạo." },
    ],
  },
  {
    id: "edit-manual-product-ad-keywords",
    module: "ads",
    name: "v2.ads.edit_manual_product_ad_keywords",
    method: "POST",
    path: "/api/v2/ads/edit_manual_product_ad_keywords",
    description: "Chỉnh sửa, thêm hoặc xóa từ khóa cho quảng cáo sản phẩm thủ công.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/edit_manual_product_ad_keywords" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_manual_product_ad_keywords" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "ad_id", type: "int64", required: true, description: "ID quảng cáo." },
      { name: "keyword_list", type: "object[]", required: true, description: "Danh sách từ khóa cần chỉnh sửa." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
  ...
  {
    id: "edit-manual-product-ads",
    module: "ads",
    name: "v2.ads.edit_manual_product_ads",
    method: "POST",
    path: "/api/v2/ads/edit_manual_product_ads",
    description: "Chỉnh sửa thông tin chung (ngân sách, thời gian) của quảng cáo sản phẩm thủ công.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/edit_manual_product_ads" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_manual_product_ads" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "ad_id", type: "int64", required: true, description: "ID quảng cáo." },
      { name: "budget", type: "float", required: false, description: "Ngân sách mới." },
      { name: "status", type: "string", required: false, description: "Trạng thái mới: active hoặc paused." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
  ...
  {
    id: "get-create-product-ad-budget-suggestion",
    module: "ads",
    name: "v2.ads.get_create_product_ad_budget_suggestion",
    method: "GET",
    path: "/api/v2/ads/get_create_product_ad_budget_suggestion",
    description: "Lấy gợi ý ngân sách khi tạo quảng cáo sản phẩm mới.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_create_product_ad_budget_suggestion" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_create_product_ad_budget_suggestion" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "item_id_list", type: "int64[]", required: true, description: "Danh sách ID sản phẩm." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Gợi ý ngân sách cho từng sản phẩm." },
    ],
  },
  {
    id: "get-product-recommended-roi-target",
    module: "ads",
    name: "v2.ads.get_product_recommended_roi_target",
    method: "GET",
    path: "/api/v2/ads/get_product_recommended_roi_target",
    description: "Lấy mục tiêu ROI khuyến nghị cho quảng cáo sản phẩm.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_product_recommended_roi_target" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_recommended_roi_target" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "ROI đề xuất cho từng sản phẩm." },
    ],
  },
  {
    id: "get-ads-facil-shop-rate",
    module: "ads",
    name: "v2.ads.get_ads_fácil_shop_rate",
    method: "GET",
    path: "/api/v2/ads/get_ads_fácil_shop_rate",
    description: "Lấy tỷ lệ phí dịch vụ Ads Fácil cho cửa hàng.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_ads_fácil_shop_rate" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_ads_fácil_shop_rate" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object", description: "Thông tin tỷ lệ phí." },
    ],
  },
  {
    id: "check-create-gms-product-campaign-eligibility",
    module: "ads",
    name: "v2.ads.check_create_gms_product_campaign_eligibility",
    method: "GET",
    path: "/api/v2/ads/check_create_gms_product_campaign_eligibility",
    description: "Kiểm tra điều kiện để tạo chiến dịch sản phẩm GMS (Global Marketing Solutions).",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/check_create_gms_product_campaign_eligibility" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/check_create_gms_product_campaign_eligibility" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object", description: "Trạng thái đủ điều kiện." },
    ],
  },
  {
    id: "create-gms-product-campaign",
    module: "ads",
    name: "v2.ads.create_gms_product_campaign",
    method: "POST",
    path: "/api/v2/ads/create_gms_product_campaign",
    description: "Tạo chiến dịch sản phẩm GMS mới.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/create_gms_product_campaign" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/create_gms_product_campaign" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_name", type: "string", required: true, description: "Tên chiến dịch." },
      { name: "start_time", type: "int64", required: true, description: "Thời gian bắt đầu." },
      { name: "end_time", type: "int64", required: false, description: "Thời gian kết thúc." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
  ...
  {
    id: "edit-gms-product-campaign",
    module: "ads",
    name: "v2.ads.edit_gms_product_campaign",
    method: "POST",
    path: "/api/v2/ads/edit_gms_product_campaign",
    description: "Chỉnh sửa chiến dịch sản phẩm GMS.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/edit_gms_product_campaign" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_gms_product_campaign" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id", type: "int64", required: true, description: "ID chiến dịch." },
      { name: "campaign_name", type: "string", required: false, description: "Tên mới." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
  ...
  {
    id: "list-gms-user-deleted-item",
    module: "ads",
    name: "v2.ads.list_gms_user_deleted_item",
    method: "GET",
    path: "/api/v2/ads/list_gms_user_deleted_item",
    description: "Lấy danh sách các sản phẩm đã bị người dùng xóa khỏi chiến dịch GMS.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/list_gms_user_deleted_item" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/list_gms_user_deleted_item" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "int64[]", description: "Danh sách item_id đã xóa." },
    ],
  },
  {
    id: "edit-gms-item-product-campaign",
    module: "ads",
    name: "v2.ads.edit_gms_item_product_campaign",
    method: "POST",
    path: "/api/v2/ads/edit_gms_item_product_campaign",
    description: "Chỉnh sửa cài đặt sản phẩm trong chiến dịch GMS.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/edit_gms_item_product_campaign" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_gms_item_product_campaign" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id", type: "int64", required: true, description: "ID chiến dịch." },
      { name: "item_list", type: "object[]", required: true, description: "Danh sách sản phẩm và cài đặt." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
  ...
  {
    id: "get-gms-campaign-performance",
    module: "ads",
    name: "v2.ads.get_gms_campaign_performance",
    method: "GET",
    path: "/api/v2/ads/get_gms_campaign_performance",
    description: "Lấy hiệu suất của chiến dịch GMS.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_gms_campaign_performance" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_gms_campaign_performance" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    requestParams: [
      { name: "campaign_id", type: "int64", required: true, description: "ID chiến dịch." },
      { name: "start_date", type: "string", required: true, description: "Ngày bắt đầu." },
      { name: "end_date", type: "string", required: true, description: "Ngày kết thúc." },
    ],
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Dữ liệu hiệu suất." },
    ],
  },
  {
    id: "get-gms-item-performance",
    module: "ads",
    name: "v2.ads.get_gms_item_performance",
    method: "GET",
    path: "/api/v2/ads/get_gms_item_performance",
    description: "Lấy hiệu suất của từng sản phẩm trong chiến dịch GMS.",
    environments: [
      { name: "URL", url: "https://partner.shopeemobile.com/api/v2/ads/get_gms_item_performance" },
      { name: "Test URL", url: "https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_gms_item_performance" },
    ],
    commonParams: [
      { name: "partner_id", type: "int", sample: "1", description: "ID đối tác." },
      { name: "timestamp", type: "timestamp", sample: "1610000000", description: "Thời gian request." },
    ...
    responseParams: [
      { name: "error", type: "string", description: "Mã lỗi." },
      { name: "message", type: "string", description: "Mô tả lỗi." },
      { name: "response", type: "object[]", description: "Dữ liệu hiệu suất sản phẩm." },
    ],
  },
